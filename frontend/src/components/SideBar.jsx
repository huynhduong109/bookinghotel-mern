                        ...
                        <NavLink to="/admin/dashboard">
                            {({ isActive }) => (
                                ...
                                >
                                    ...
                                    >
                                        <DashboardSharpIcon className="text-red-400" />
                                    </ListItemIcon>
                                    <ListItemText className="text-red-400 font-semibold" primary="Bảng điều khiển" sx={{ opacity: open ? 1 : 0 }} />
                                </ListItemButton>
                            )}
                        </NavLink>
                    </Tooltip>
                        ...
                        <NavLink to="/admin/users">
                            {({ isActive }) => (
                                ...
                                >
                                    ...
                                    <ListItemText className="text-red-400 font-semibold" primary="Tất cả người dùng" sx={{ opacity: open ? 1 : 0 }} />
                                </ListItemButton>
                            )}
                        </NavLink>
                    </Tooltip>
                        ...
                        <NavLink to="/admin/hotels">
                            {({ isActive }) => (
                                ...
                                >
                                    ...
                                    <ListItemText className="text-red-400 font-semibold" primary="Tất cả khách sạn" sx={{ opacity: open ? 1 : 0 }} />
                                </ListItemButton>
                            )}
                        </NavLink>
                    </Tooltip>
                        ...
                        <NavLink to="/admin/hotel/new">
                            {({ isActive }) => (
                                ...
                                >
                                    ...
                                    <ListItemText className="text-red-400 font-semibold" primary="Tạo khách sạn mới" sx={{ opacity: open ? 1 : 0 }} />
                                </ListItemButton>
                            )}
                        </NavLink>
                    </Tooltip>
                        ...
                        <NavLink to="/admin/bookings">
                            {({ isActive }) => (
                                ...
                                >
                                    ...
                                    <ListItemText className="text-red-400 font-semibold" primary="Tất cả lịch đặt" sx={{ opacity: open ? 1 : 0 }} />
                                </ListItemButton>
                            )}
                        </NavLink>
                    </Tooltip>
