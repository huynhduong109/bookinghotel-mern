    ...
    return (
        <div className="flex flex-col w-80 gap-8 bg-stone-100 shadow-md rounded-md">
            ...
            <div className="mx-4 mb-6">
                ...
                <p className=" my-3 font-medium">Loại phòng: <span className="font-normal font-mono">{room.type}</span></p>
                ...
                <span className="text-xl font-medium"><RequestQuoteIcon className="mb-1 mr-1" />{room.pricePerDay.toLocaleString("vi-VN", {
                        style: "currency",
                        currency: "VND",
                      }) + ""}/ngày</span>
