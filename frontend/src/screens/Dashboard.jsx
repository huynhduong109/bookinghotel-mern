...
const Dashboard = () => {
    ...
    useEffect(() => {
     ...
     //chart;
  const deliveredOrdersInfo = allBookings?.map((order) => {
    return {
      day: order.createdAt.slice(0, 10),
      total: order.totalPrice,
    };
  });
  console.log(deliveredOrdersInfo)
...
console.log(generateMonthlyBookingCount(allDates))
    const lineState = {
        ...
        <Fragment>
            ...
            <div className="flex">
                ...
                <div className="mx-auto w-full lg:mt-16 sm:mt-8 mt-5 md:mt-12">
                    <h2 className="text-center mb-12 font-medium text-2xl text-red-400">Bảng điều khiển</h2>
                    ...
                    <div className="w-11/12 md:w-3/5 aspect-auto my-20 mx-auto">
                        <h2 className="text-center mb-8 font-medium text-xl text-red-400">Thống kê đặt chỗ theo tháng</h2>
                        <Bar data={lineState} options={options} className="w-full" />
                    </div>
                    <div className="w-11/12 md:w-3/5 aspect-auto my-20 mx-auto">
                       <ChartComponentShop arrData={deliveredOrdersInfo && deliveredOrdersInfo} ></ChartComponentShop>
                    </div>
                </div>
            </div>
        </Fragment>
